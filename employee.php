...
$sql = "INSERT INTO register (employee_name,email,job,salary,gender)
...
<button name="view" id="button" onclick= 'window.location.replace("display_data.php")'w3>VIEW</button>
</center>
</div>
</body>
</html>